...
const DEFAULT_API_BASE_URL = 'http://10.12.129.12:4000';
...
export function assertApiBaseUrl(): void {
  if (!/^https?:\/\//i.test(API_BASE_URL)) {
    throw new Error(
      'API URL is not configured. Add EXPO_PUBLIC_API_URL=http://10.12.124.62:4000 to .env and restart Expo with npx expo start -c.'
    );
  }
}
